...
public class HotelsFragment extends Fragment {
    ...
    List<Data> list;
    List<com.example.pablo.model.hotels.Data> list1;
    Service service;
    ...
    private void getHotel() {
        ...
        service.getHotels(token).enqueue(new Callback<List<Data>>() {
            @Override
    ...
    private void getPopularHotel() {
        ...
        service.getPopularHotels(token).enqueue(new Callback<List<com.example.pablo.model.hotels.Data>>() {
            @Override
            public void onResponse(Call<List<com.example.pablo.model.hotels.Data>> call, Response<List<com.example.pablo.model.hotels.Data>> response) {
            ...
            @Override
            public void onFailure(Call<List<com.example.pablo.model.hotels.Data>> call, Throwable t) {
                t.printStackTrace();
